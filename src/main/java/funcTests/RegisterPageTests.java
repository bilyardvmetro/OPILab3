...
public class RegisterPageTests {
    ...
    public void testRegisterFail() {
        ...
        WebElement alert = driver.findElement(By.id("register-error"));

        loginInput.sendKeys("kirill");
        passwordInput.sendKeys("234234ffff");
        submitBtn.click();
        ...
        Assertions.assertEquals("Имя пользователя уже занятно", alertText);
